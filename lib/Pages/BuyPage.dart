...
class BuyPage extends StatefulWidget {
  ...
  const BuyPage({Key? key, required this.navigateToHomePageCallback, required this.webUrl})
      : super(key: key);
...
class _BuyPageState extends State<BuyPage> {
  ...
  void initState() {
   ...
   // _controller = LoadUrlController(controller, '${BaseUrl}/buy/toronto-real-estate', context);
